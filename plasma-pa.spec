...
Source0  : https://download.kde.org/stable/plasma/5.27.5/plasma-pa-5.27.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.5/plasma-pa-5.27.5.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.27.5
cd %{_builddir}/plasma-pa-5.27.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684807026
mkdir -p clr-build
pushd clr-build
