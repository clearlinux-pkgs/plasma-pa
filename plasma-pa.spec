...
Source0  : https://download.kde.org/stable/plasma/6.4.0/plasma-pa-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/plasma-pa-6.4.0.tar.xz.sig
...
%setup -q -n plasma-pa-6.4.0
cd %{_builddir}/plasma-pa-6.4.0
pushd ..
cp -a plasma-pa-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750184400
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libplasma-volume.so.6.4.0
/V3/usr/lib64/qt6/plugins/kf6/kded/audioshortcutsservice.so
/V3/usr/lib64/qt6/plugins/plasma/applets/org.kde.plasma.volume.so
...
/usr/lib64/libplasma-volume.so.6.4.0
/usr/lib64/qt6/plugins/kf6/kded/audioshortcutsservice.so
/usr/lib64/qt6/plugins/plasma/applets/org.kde.plasma.volume.so
