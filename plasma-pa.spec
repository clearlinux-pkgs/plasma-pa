...
Version  : 5.14.1
Release  : 5
URL      : https://download.kde.org/stable/plasma/5.14.1/plasma-pa-5.14.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.1/plasma-pa-5.14.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.1/plasma-pa-5.14.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1539733759
mkdir -p clr-build
pushd clr-build
%cmake ..
