...
Version  : 5.27.2
Release  : 78
URL      : https://download.kde.org/stable/plasma/5.27.2/plasma-pa-5.27.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.2/plasma-pa-5.27.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.2/plasma-pa-5.27.2.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.27.2
cd %{_builddir}/plasma-pa-5.27.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677600663
mkdir -p clr-build
pushd clr-build
