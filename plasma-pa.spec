...
Version  : 5.14.2
Release  : 6
URL      : https://download.kde.org/stable/plasma/5.14.2/plasma-pa-5.14.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.2/plasma-pa-5.14.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.2/plasma-pa-5.14.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1540473329
mkdir -p clr-build
pushd clr-build
%cmake ..
