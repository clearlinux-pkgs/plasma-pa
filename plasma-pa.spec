...
Version  : 6.1.3
Release  : 101
URL      : https://download.kde.org/stable/plasma/6.1.3/plasma-pa-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/plasma-pa-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/plasma-pa-6.1.3.tar.xz.sig
...
%setup -q -n plasma-pa-6.1.3
cd %{_builddir}/plasma-pa-6.1.3
pushd ..
cp -a plasma-pa-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721147527
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libplasma-volume.so.6.1.3
...
/usr/lib64/libplasma-volume.so.6.1.3
