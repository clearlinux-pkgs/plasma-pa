...
Version  : 6.1.0
Release  : 98
URL      : https://download.kde.org/stable/plasma/6.1.0/plasma-pa-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/plasma-pa-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/plasma-pa-6.1.0.tar.xz.sig
...
%package dev
Summary: dev components for the plasma-pa package.
Group: Development
Requires: plasma-pa-lib = %{version}-%{release}
Requires: plasma-pa-data = %{version}-%{release}
Provides: plasma-pa-devel = %{version}-%{release}
Requires: plasma-pa = %{version}-%{release}

%description dev
dev components for the plasma-pa package.
...
%setup -q -n plasma-pa-6.1.0
cd %{_builddir}/plasma-pa-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718905620
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libplasma-volume.so.6.1.0
...
/usr/lib64/libplasma-volume.so.6.1.0
