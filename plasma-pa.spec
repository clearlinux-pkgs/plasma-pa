...
Source0  : https://download.kde.org/stable/plasma/6.3.4/plasma-pa-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/plasma-pa-6.3.4.tar.xz.sig
...
%setup -q -n plasma-pa-6.3.4
cd %{_builddir}/plasma-pa-6.3.4
pushd ..
cp -a plasma-pa-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744128924
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libplasma-volume.so.6.3.4
...
/usr/lib64/libplasma-volume.so.6.3.4
