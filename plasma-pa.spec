...
Source0  : https://download.kde.org/stable/plasma/5.26.2/plasma-pa-5.26.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.2/plasma-pa-5.26.2.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.26.2
cd %{_builddir}/plasma-pa-5.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667241212
mkdir -p clr-build
pushd clr-build
