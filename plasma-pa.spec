...
Version  : 5.15.3
Release  : 13
URL      : https://download.kde.org/stable/plasma/5.15.3/plasma-pa-5.15.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.15.3/plasma-pa-5.15.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.15.3/plasma-pa-5.15.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1552413655
mkdir -p clr-build
pushd clr-build
