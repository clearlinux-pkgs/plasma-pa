...
Source0  : https://download.kde.org/stable/plasma/6.0.3/plasma-pa-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/plasma-pa-6.0.3.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-6.0.3
cd %{_builddir}/plasma-pa-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711668857
mkdir -p clr-build
pushd clr-build
