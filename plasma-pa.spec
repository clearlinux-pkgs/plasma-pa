...
Source0  : https://download.kde.org/stable/plasma/5.27.3/plasma-pa-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/plasma-pa-5.27.3.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.27.3
cd %{_builddir}/plasma-pa-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679516180
mkdir -p clr-build
pushd clr-build
