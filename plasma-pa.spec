...
Version  : 5.27.9
Release  : 87
URL      : https://download.kde.org/stable/plasma/5.27.9/plasma-pa-5.27.9.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.9/plasma-pa-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/plasma-pa-5.27.9.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.27.9
cd %{_builddir}/plasma-pa-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698282707
mkdir -p clr-build
pushd clr-build
