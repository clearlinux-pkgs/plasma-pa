...
Version  : 5.27.10
Release  : 88
URL      : https://download.kde.org/stable/plasma/5.27.10/plasma-pa-5.27.10.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/plasma-pa-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/plasma-pa-5.27.10.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.27.10
cd %{_builddir}/plasma-pa-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702975580
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt5/plugins/plasma/kcms/systemsettings/kcm_pulseaudio.so
/V3/usr/lib64/qt5/qml/org/kde/plasma/private/volume/libplasma-volume-declarative.so
