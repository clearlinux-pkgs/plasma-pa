...
Source0  : https://download.kde.org/stable/plasma/5.26.4/plasma-pa-5.26.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.4/plasma-pa-5.26.4.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.26.4
cd %{_builddir}/plasma-pa-5.26.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669817114
mkdir -p clr-build
pushd clr-build
