...
Source0  : https://download.kde.org/stable/plasma/5.27.6/plasma-pa-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/plasma-pa-5.27.6.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.27.6
cd %{_builddir}/plasma-pa-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687284651
mkdir -p clr-build
pushd clr-build
