...
Version  : 5.27.4
Release  : 81
URL      : https://download.kde.org/stable/plasma/5.27.4/plasma-pa-5.27.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.4/plasma-pa-5.27.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.4/plasma-pa-5.27.4.tar.xz.sig
...
%prep
%setup -q -n plasma-pa-5.27.4
cd %{_builddir}/plasma-pa-5.27.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682268088
mkdir -p clr-build
pushd clr-build
